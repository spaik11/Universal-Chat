...
const messages = [
  ...
  { authorId: id(), content: 'I want to get tacos!', channelId: 3 },
  { authorId: id(), content: 'I want to get salad!', channelId: 3 },
  { authorId: id(), content: 'I want a taco salad!', channelId: 3 },
];
